...
if __name__ == "__main__":
    precision = 8
    batch_size = 200
    data_set_name = 'Googlemap_CT'
    pretrained_model_name = './llm_model'#'bert-base-uncased'
    ...
    for data_set_name in ['Amazon_movies']:
        ...
        np.save('./DyLink_Datasets/' + data_set_name + '/e_feat.npy', entity_embeddings)
        ...
        np.save('./DyLink_Datasets/' + data_set_name + '/r_feat.npy', rel_embeddings)
